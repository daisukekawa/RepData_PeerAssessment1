...
plot(step_ave, type="l", col="blue", main="Average daily activity pattern", xlab="interval", ylab="average number of steps")
...
par(mfcol = c(2,1))
plot(step_wend, type="l", col="blue", main="Weekend", xlab="interval", ylab="average number of steps")
plot(step_wday, type="l", col="blue", main="Weekday", xlab="interval", ylab="average number of steps")
